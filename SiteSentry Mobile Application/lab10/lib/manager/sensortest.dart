...
class Sensor extends StatefulWidget {
  ...
  @override
  State<Sensor> createState() => SensorPageM();
}

class SensorPageM extends State<Sensor> {
  ...
  void _activateListeners() {
    ...
    _databaseTemp.child("DHT11/Temperature").onValue.listen((event) {
      ...
      setState(() {
        ...
        if (_displayText < 70 && (_displayText2 < 15 || _displayText2 > 45)) {
          showNotificationBoth();
        } else if (_displayText < 70) {
          showNotificationHumidity();
        } else if (_displayText2 < 15 || _displayText2 > 45) {
