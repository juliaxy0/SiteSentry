...
class NotificationAlertWorker extends StatefulWidget {
  const NotificationAlertWorker({super.key});

  @override
  State<NotificationAlertWorker> createState() => _NotificationAlertStateW();
}

class _NotificationAlertStateW extends State<NotificationAlertWorker> {
  int currentPage = 0;
  @override
